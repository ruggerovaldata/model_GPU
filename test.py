...
parser.add_argument('width', type=float, help='Width of the gaussians')
...
if load: 
    ...
    model.load_state_dict(torch.load('FRBAEGPU10240616:03.pt',map_location=torch.device(device)))
