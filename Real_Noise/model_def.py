...
class VariationalAutoEncoder(nn.Module):
  def __init__(self,input_dim,x_size,y_size, nu, nu0,t,width, h_dim = 500, z_dim_params = 2, z_dim_noise = 500):
...
class VariationalAutoEncoder_noswidth_RealNoise(nn.Module):
  def __init__(self,input_dim,x_size,y_size, nu, nu0,t,width, h_dim = 100, h1_dim = 50, h2_dim = 50, z_dim_params = 2, z_dim_noise = 1000):
