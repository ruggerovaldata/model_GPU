...
def CreateDataset(DM_min,DM_max, nu_i,nu_f, N, t, x_size, y_size, width,  batch_size, noise = 7, test_flag=False):
    ...
    noises_train = rand_interv(3,10, n_training)
    swidth_train = rand_interv(100,5000,n_training)
    ...
    noises_test = rand_interv(3,10, n_test)
    swidth_test = rand_interv(100,5000,n_test)
